...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='cfgs/waymo_models/centerpoint_4frames_test.yaml',
    ...
    parser.add_argument('--ckpt', type=str,
                        default='../output/waymo_models/centerpoint_4frames_test/default/ckpt/checkpoint_epoch_9.pth',
