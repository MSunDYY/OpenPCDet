...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='cfgs/waymo_models/centerpoint.yaml',
    ...
    parser.add_argument('--ckpt', type=str,
                        default='../output/waymo_models/centerpoint/default/ckpt/checkpoint_epoch_10.pth',
