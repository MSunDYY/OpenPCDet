...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='cfgs/waymo_models/mppnet_4frames.yaml',
                        help='specify the config for training')

    parser.add_argument('--batch_size', type=int, default=10, required=False, help='batch size for training')
    parser.add_argument('--workers', type=int, default=4, help='number of workers for dataloader')
    parser.add_argument('--extra_tag', type=str, default='default', help='extra tag for this experiment')
    parser.add_argument('--ckpt', type=str,
                        default='../output/waymo_models/mppnet_4frames/Interval1/ckpt/checkpoint_epoch_6.pth',
