...
def parse_config():
    ...
    parser.add_argument('--pretrained_model', type=str, default='../output/waymo_models/centerspeed/b10_speed0.5_diff0_gt1_sps0.0001_spg0/ckpt/checkpoint_epoch_10.pth', help='pretrained_model')
