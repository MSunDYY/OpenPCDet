...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='cfgs/waymo_models/velocity_4frames.yaml',
    ...
    parser.add_argument('--pretrained_model', type=str, default='../output/waymo_models/centerspeed/sp0.7_gt1_mo_0.8_bs8/ckpt/checkpoint_epoch_6.pth', help='pretrained_model')
