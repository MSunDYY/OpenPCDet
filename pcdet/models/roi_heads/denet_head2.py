...
from ..model_utils.denet2_utils import build_transformer, PointNet, MLP, build_voxel_sampler, build_voxel_sampler_traj
...
class DENet2Head(RoIHeadTemplate):
    ...
    def forward(self, batch_dict):
        ...
        batch_dict['src'] = src.unflatten(1,(4,-1)).permute(1,0,2,3).flatten(0,1)
        ...
        hs, tokens = self.transformer(src, pos=None,batch_dict=batch_dict)
